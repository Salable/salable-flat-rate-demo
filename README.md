...
This demo is to demonstrate using flat rate billing with Salable. [View docs](https://www.salable.app/features/flat-rate-pricing)
...
### Checkout
This instance of Salable is integrated with Stripe in test mode so no real money will ever taken.
The customer email will be pre-populated with the email you have signed up with
In the Stripe checkout use the card number `4242 4242 4242 4242`, set a date in the future and the `CVC` can be any three digit number
